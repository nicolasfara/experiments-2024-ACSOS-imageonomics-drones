...
class BodyCoverageMetricCalculatorTest {
    ...
    fun `the metric for 4 perpendicular cameras should return 1`() {
        ...
        val bodyPosition = Euclidean2DPosition(0.0, 0.0) to Euclidean2DPosition(1.0, 0.0)
        val camerasPositions = listOf(
            Euclidean2DPosition(2.0, 0.0) to Euclidean2DPosition(-1.0, 0.0), // pointing to the left
            Euclidean2DPosition(-2.0, 0.0) to Euclidean2DPosition(1.0, 0.0), // pointing to the right
            Euclidean2DPosition(0.0, 2.0) to Euclidean2DPosition(0.0, -1.0), // pointing down
            Euclidean2DPosition(0.0, -2.0) to Euclidean2DPosition(0.0, 1.0), // pointing up
        )
