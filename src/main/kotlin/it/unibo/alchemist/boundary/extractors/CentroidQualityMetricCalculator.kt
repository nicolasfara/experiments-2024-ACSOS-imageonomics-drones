...
class CentroidQualityMetricCalculator<T>(
    ...
    override fun cloneOnNewNode(node: Node<T>): NodeProperty<T> = CentroidQualityMetricCalculator(environment, node, visionMolecule.name, targetMolecule.name)
