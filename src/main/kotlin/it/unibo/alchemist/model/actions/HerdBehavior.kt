...
import it.unibo.alchemist.boundary.extractors.FovDistance
...
class HerdBehavior @JvmOverloads constructor(
    ...
    override fun execute() {
        ...
        if (node.contains(SimpleMolecule("zebra"))) {
            ...
            node.setConcentration(FovDistance.fovDistanceMolecule, centroidQualityProperty.computeCentroidQuality())
        }
    }
